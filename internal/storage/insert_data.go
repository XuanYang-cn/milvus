...
func NewInsertData(schema *schemapb.CollectionSchema) (*InsertData, error) {
	...
	for _, field := range schema.Fields {
		fieldData, _ := NewFieldData(field.DataType, field.TypeParams)
		// no error for valid schema TODO
		// if err != nil {
		//     return nil, err
		// }
...
// TODO add init size
func NewFieldData(dataType schemapb.DataType, typeParams []*commonpb.KeyValuePair) (FieldData, error) {
	switch dataType {
