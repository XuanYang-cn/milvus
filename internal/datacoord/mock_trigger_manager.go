...
// ManualTrigger provides a mock function with given fields: ctx, collectionID, clusteringCompaction, targetSize
func (_m *MockTriggerManager) ManualTrigger(ctx context.Context, collectionID int64, clusteringCompaction bool, targetSize int64) (int64, error) {
	ret := _m.Called(ctx, collectionID, clusteringCompaction, targetSize)
>>>>>>> 0062724a64 (feat: Add force merge)
	...
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64, bool, int64) (int64, error)); ok {
		return rf(ctx, collectionID, clusteringCompaction, targetSize)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64, bool, int64) int64); ok {
		r0 = rf(ctx, collectionID, clusteringCompaction, targetSize)
	} else {
		r0 = ret.Get(0).(int64)
	}

	if rf, ok := ret.Get(1).(func(context.Context, int64, bool, int64) error); ok {
		r1 = rf(ctx, collectionID, clusteringCompaction, targetSize)
	} else {
		r1 = ret.Error(1)
	}
...
//   - targetSize int64
func (_e *MockTriggerManager_Expecter) ManualTrigger(ctx interface{}, collectionID interface{}, clusteringCompaction interface{}, targetSize interface{}) *MockTriggerManager_ManualTrigger_Call {
	return &MockTriggerManager_ManualTrigger_Call{Call: _e.mock.On("ManualTrigger", ctx, collectionID, clusteringCompaction, targetSize)}
}

func (_c *MockTriggerManager_ManualTrigger_Call) Run(run func(ctx context.Context, collectionID int64, clusteringCompaction bool, targetSize int64)) *MockTriggerManager_ManualTrigger_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTriggerManager_ManualTrigger_Call) RunAndReturn(run func(context.Context, int64, bool, int64) (int64, error)) *MockTriggerManager_ManualTrigger_Call {
	_c.Call.Return(run)
	return _c
}
